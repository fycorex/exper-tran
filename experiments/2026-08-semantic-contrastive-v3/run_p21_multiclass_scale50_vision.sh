...
export V3_SCALE50_OUTPUT_DIR="${V3_P21_SCALE50_OUTPUT_DIR:-outputs/proxy_selector_semantic_contrastive_v3_scale50_multiclass_p21_vision17}"
export V3_SCALE50_SEMANTIC_MODE=multiclass_prototype
export V3_SCALE50_PAIR_IDS=P21
