        ...
        rows.append(
            {
                ...
                "rho": payload["rho"],
                "semantic_temperature": payload.get("semantic_temperature", 0.1),
                "target_logit_weight": payload.get("target_logit_weight", 1.0),
                "source_logit_weight": payload.get("source_logit_weight", 1.0),
